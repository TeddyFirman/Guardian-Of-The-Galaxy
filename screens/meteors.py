...
def meteors():
    ...
    while run:
        ...
        Assets.text.draw(Text.METEORS, ships_title_font, Colors.CYAN,
                         (config.center_x, 100), True, False, True)
        Assets.image.draw(Image.OBSTACLE,
                          (config.center_x + 140, 99), True)
        ...
        Assets.image.draw(Image.MEDIUM_OBSTACLE,
                          (config.center_x - 270, 295), True)
        Assets.text.draw('Medium Obstacle', ships_info_font, Colors.BLUE,
        ...
        Assets.text.draw('Hard Obstacle', ships_info_font, Colors.BLUE,
